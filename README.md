...
Incheon National University에서 컴퓨터공학을 전공하고, 현재 **DOST11**에서 AI Researcher로 일하고 있습니다. 생성형 미디어 모델을 다루고, VLM 파인튜닝(LoRA/QLoRA)과 RAG·멀티 에이전트·MLOps 시스템을 연구합니다. 이론적 엄밀함과 프로덕션 엔지니어링을 함께 추구하는 것을 지향합니다.
